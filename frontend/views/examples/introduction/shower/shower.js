...
window.shower =
  ...
  (function(window, document, undefined) {
    ...
    shower._getTransform = function() {
      var denominator = Math.max(body.clientWidth / window.innerWidth, body.clientHeight / window.innerHeight);
    ...
    shower._applyTransform = function(transform) {
      ['WebkitTransform', 'MozTransform', 'msTransform', 'OTransform', 'transform'].forEach(function(prop) {
    ...
    shower.updateProgress = function(slideNumber) {
      ...
      progress.style.width =
        ((100 / (shower.slideList.length - 1)) * shower._normalizeSlideNumber(slideNumber)).toFixed(2) + '%';
